...
public final class SparseAsserts {
  /**
   * Asserts that {@link SparseIntArray} are equal. Equal is defined either as same sizes, same keys
   * and values at each index or if both are null.
   *
   * @param expected expected SparseIntArray
   * @param actual actual SparseIntArray
   */
  public static void assertSparseIntArrayEquals(@Nullable final SparseIntArray expected,
      @Nullable final SparseIntArray actual) {
  ...
  /**
   * Asserts that {@link SparseBooleanArray} are equal. Equal is defined either as same sizes, same
   * keys and values at each index or if both are null.
   *
   * @param expected expected SparseBooleanArray
   * @param actual actual SparseBooleanArray
   */
  public static void assertSparseBooleanArrayEquals(@Nullable final SparseBooleanArray expected,
      @Nullable final SparseBooleanArray actual) {
    if (!SparseAsserts.assertNullability(expected, actual)) {
      assertSizesEqual(expected.size(), actual.size());
  ...
  /**
   * Asserts that {@link SparseArray} are equal. Equal is defined either as same sizes, same keys
   * and values at each index or if both are null.
   *
   ...
   */
  public static <T> void assertSparseArrayEquals(@Nullable final SparseArray<T> expected,
      @Nullable final SparseArray<T> actual) {
    if (!SparseAsserts.assertNullability(expected, actual)) {
      assertSizesEqual(expected.size(), actual.size());
